...
import vn.com.hf.review.web.rest.errors.BadRequestAlertException;
...
public class ReviewResource {
    ...
    private static final String ENTITY_NAME = "hfReviewServiceReview";
    ...
    @Timed
    public List<ReviewDTO> getAllReviewsOfProductId(@PathVariable Long id) {
        log.debug("REST request to get all Reviews");
        return reviewService.findAll();
    }
