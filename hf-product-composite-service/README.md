...
To optimize the hfProductCompositeService application for production, run:
...
[Doing API-First development]: https://www.jhipster.tech/documentation-archive/v5.3.0/doing-api-first-development/
